 ...
 */
public class DolarActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(Global.jsonList!=null){
            for (int i = 0; i < Global.jsonList.size(); i++) {
                ...
                map.put("ALIS", model.getDolarAlis());
                map.put("SATIS", model.getDolarSatis());

                if("0".equals(model.getDolarDurum()))
                map.put("DURUM",String.valueOf(R.drawable.normal));
                else    if("1".equals(model.getDolarDurum()))
