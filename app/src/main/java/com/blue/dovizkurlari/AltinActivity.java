 ...
 */
public class AltinActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(Global.jsonList!=null){
            for (int i = 0; i < Global.jsonList.size(); i++) {
                ...
                map.put("ALIS", model.getAltinAlis());
                map.put("SATIS", model.getAltinSatis());


                if("0".equals(model.getAltinDurum()))
                    map.put("DURUM",String.valueOf(R.drawable.normal));
                else    if("1".equals(model.getAltinDurum()))
